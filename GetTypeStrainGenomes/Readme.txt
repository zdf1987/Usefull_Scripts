...
3. Modify the url in line 14 of 'GetTypeStrainNumFromLPSN.py' to the url of the taxon of interest (e.g. https://lpsn.dsmz.de/order/rhodobacterales), and run this script in IDLE of Python;
